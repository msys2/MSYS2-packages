...
for package in "${packages[@]}"; do
    cd "${package}"
    execute     'Installing dependencies' makepkg --skippgpcheck --noconfirm --noprogressbar --syncdeps --noprepare --nobuild
    execute     'Building'                makepkg --skippgpcheck --noextract --nocheck
