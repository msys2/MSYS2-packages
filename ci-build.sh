...
git_config user.email 'mati865@gmail.com'
git_config user.name  'mati865 Continuous Integration'
git remote add upstream 'https://github.com/mati865/MSYS2-packages'
